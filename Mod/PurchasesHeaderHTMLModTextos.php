 ...
 */
class PurchasesHeaderHTMLModTextos implements PurchasesModInterface
{
	...
	private static function textGroup(Translator $i18n, PurchaseDocument $model): string
    {
        $html = '<div class="col-sm-auto">'
            . '<div class="form-group">'
			. '<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#ModalTextGroups">'
            . '<i class="fas fa-spell-check" aria-hidden="true"></i> ' . $i18n->trans('texts') . '</button>'
            . '</div>'
            . '</div>'
	...
	private static function groupsTextModal(Translator $i18n, PurchaseDocument $model): string
    {
